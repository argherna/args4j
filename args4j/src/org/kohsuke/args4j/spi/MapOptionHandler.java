 ...
 *
 * <p>
 * With this, <code>-P x=1 -P y=2</code> parses to map of size {@code 2}. This option handler can be
 * subtyped if you want to convert values to different types or to handle <code>key=value</code> in
 * other formats, like <code>key:=value</code>.
 */
public class MapOptionHandler extends OptionHandler<Map<?, ?>> {

    public MapOptionHandler(CmdLineParser parser, OptionDef option,
    ...
    public int parseArguments(Parameters params) throws CmdLineException {
        ...
        Map<String, String> v = (Map<String, String>) fs.getValue();
        if (v == null) {
     ...
     */
    protected Map<String, String> createNewCollection(Class<? extends Map<String, String>> type) {
        return new HashMap<>();
    }
     ...
     */
    protected void addToMap(String argument, Map<String, String> m) throws CmdLineException {
     ...
     */
    protected void addToMap(Map<String, String> m, String key, String value) {
        m.put(key, value);
    }
