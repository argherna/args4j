...
public class OptionHandlerRegistryTest {

    public static class CustomTypeOptionHandler extends OneArgumentOptionHandler<CustomType> {
        public CustomTypeOptionHandler(CmdLineParser parser, OptionDef option,
                org.kohsuke.args4j.spi.Setter<? super CustomType> setter) {
    ...
    public void testCmdLineParserWithUnregistered() {
        assertThrows(IllegalAnnotationError.class, () -> new CmdLineParser(new TestBean()));
    }
    ...
    public void testOptionHandlerFactory() throws CmdLineException {
        ...
        OptionHandlerRegistry.getRegistry().registerHandler(OhfTestType.class,
                new OptionHandlerRegistry.OptionHandlerFactory() {
                    public OptionHandler<OhfTestType> getHandler(CmdLineParser parser, OptionDef o,
                            Setter setter) {
